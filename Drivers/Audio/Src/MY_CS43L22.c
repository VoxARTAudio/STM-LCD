...
{
  uint8_t iData[2];
	__HAL_UNLOCK(&hi2s2);     // THIS IS EXTREMELY IMPORTANT FOR I2S3 TO WORK!!
	__HAL_I2S_ENABLE(&hi2s2); // THIS IS EXTREMELY IMPORTANT FOR I2S3 TO WORK!!
